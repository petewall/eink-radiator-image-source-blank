...
type FakeImageGenerator struct {
	GenerateImageStub        func(int, int) internal.ImageContext
...
func (fake *FakeImageGenerator) GenerateImage(arg1 int, arg2 int) internal.ImageContext {
...
func (fake *FakeImageGenerator) GenerateImageCalls(stub func(int, int) internal.ImageContext) {
	fake.generateImageMutex.Lock()
...
func (fake *FakeImageGenerator) GenerateImageReturns(result1 internal.ImageContext) {
	fake.generateImageMutex.Lock()
	defer fake.generateImageMutex.Unlock()
...
func (fake *FakeImageGenerator) GenerateImageReturnsOnCall(i int, result1 internal.ImageContext) {
	fake.generateImageMutex.Lock()
	defer fake.generateImageMutex.Unlock()
	fake.GenerateImageStub = nil
